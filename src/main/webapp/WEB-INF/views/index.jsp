	            ...
	            <form class="replyform">
	              ...
	              <div class="r_info">
			        <label class="r_info_label">
			            <div class="r_info_title" style = "width : 400px; margin :auto; margin-top : -15px; margin-left :-5px; overflow : auto; height : 60px;">
			        ...
			        <c:forEach var="reply" items="${replys}">
			            <c:if test="${reply.board.id==boards.id}">
			                <div class="r_reply">
			                    ...
			                    <div class="r_profile">
			                        <div class="r_p_img">
			                            <img src="/image/cat1.jpg" id = reply_user_img>
			                        </div>
